...
if [ -f "/Users/sebasgona/go/bin/moai" ]; then
	exec "/Users/sebasgona/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/sebasgona/.local/bin/moai" ]; then
	exec "/Users/sebasgona/.local/bin/moai" statusline < "$temp_file"
fi
